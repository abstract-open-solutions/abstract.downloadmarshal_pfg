...
def setup_product():
    ...
    import abstract.downloadmarshal_pfg
    zcml.load_config('configure.zcml', abstract.downloadmarshal_pfg)
    ...
    ztc.installPackage('abstract.downloadmarshal_pfg')
...
setup_product()
ptc.setupPloneSite(products=['abstract.downloadmarshal_pfg'])
